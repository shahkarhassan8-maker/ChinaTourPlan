    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-lg p-0 gap-0 overflow-hidden">
        ...
        <div className="bg-gradient-to-br from-[#E60012] to-red-700 p-8 text-white text-center">
          ...
          <DialogDescription className="text-white/80">Your personal guide, just a message away</DialogDescription>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="space-y-3">
            {PLANS.map((plan, index) => (
              <button
                key={index}
                className={`w-full p-4 rounded-xl border-2 transition-all duration-300 text-left relative ${plan.popular
