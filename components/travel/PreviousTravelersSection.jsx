...
import { MessageCircle, MapPin, Calendar, Star, Lock, Crown } from 'lucide-react';
...
function TravelerCard({ traveler, isElite, onUpgrade }) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="mt-4 flex items-center justify-between">
        ...
        {isElite ? (
          ...
          <button
            onClick={onUpgrade}
            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white text-sm font-medium rounded-lg transition-colors"
          >
    ...
    >
      <div className="flex items-center gap-3 mb-6">
        ...
        {isElite ? (
          ...
          <span className="ml-auto px-3 py-1 bg-slate-100 text-slate-600 text-xs font-semibold rounded-full flex items-center gap-1">
      ...
      {!isElite && (
        <div className="mt-6 text-center p-4 bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl border border-amber-200">
          <p className="text-slate-600 mb-3">
            Upgrade to Elite to unlock direct contact with all verified travelers
          </p>
          <Button
            onClick={onUpgrade}
